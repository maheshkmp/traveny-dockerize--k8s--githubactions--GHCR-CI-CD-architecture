...
import type { GetUsersRoute, CreateUserRoute, GetAnalyticsRoute, GetSalesRoute, GetUserByIdRoute, UpdateUserRoute, DeleteUserRoute, GetAdminReviewsRoute, UpdateReviewStatusRoute } from "./routes/admin.route";
/**
 * GET /admin/users
...
/**
 * GET /admin/sales
 * Returns sales and subscription analytics.
 */
export declare const getSales: APIRouteHandler<GetSalesRoute>;
/**
 * GET /admin/users/:id
