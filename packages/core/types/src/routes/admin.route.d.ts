            ...
            content: {
                "application/json": {
                    schema: z.ZodObject<{
                        ...
                        plan: z.ZodDefault<z.ZodOptional<z.ZodEnum<{
                            basic: "basic";
                            pro: "pro";
                            premium: "premium";
                        }>>>;
            ...
            content: {
                "application/json": {
                    schema: z.ZodObject<{
                        ...
                        activeSubscribers: z.ZodNumber;
                        totalBasic: z.ZodNumber;
                        totalPro: z.ZodNumber;
                        totalPremium: z.ZodNumber;
...
export declare const getGA4Geography: {
    tags: string[];
    summary: string;
            ...
            content: {
                "application/json": {
                    schema: z.ZodObject<{
                        ...
                        topCities: z.ZodArray<z.ZodObject<{
                            city: z.ZodString;
                            country: z.ZodString;
                            users: z.ZodNumber;
                        }, z.core.$strip>>;
    ...
    getRoutingPath(): "/analytics/geography";
};
export type GetGA4GeographyRoute = typeof getGA4Geography;
export declare const getGA4HourlyTraffic: {
    tags: string[];
    summary: string;
    path: "/analytics/hourly-traffic";
    method: "get";
    middleware: import("hono").MiddlewareHandler<import("../types").APIBindings>[];
    responses: {
        200: {
            content: {
                "application/json": {
                    schema: z.ZodObject<{
                        ...
                        peakHour: z.ZodNumber;
                        peakUsers: z.ZodNumber;
                    }, z.core.$strip>;
                };
            };
            description: string;
    ...
    getRoutingPath(): "/analytics/hourly-traffic";
};
export type GetGA4HourlyTrafficRoute = typeof getGA4HourlyTraffic;
export declare const getGA4Devices: {
    tags: string[];
    summary: string;
    ...
    getRoutingPath(): "/analytics/devices";
};
export type GetGA4DevicesRoute = typeof getGA4Devices;
export declare const getSales: {
    tags: string[];
    summary: string;
    path: "/sales";
    method: "get";
    ...
    responses: {
        200: {
            content: {
                "application/json": {
                    schema: z.ZodObject<{
                        recentSubscriptions: z.ZodArray<z.ZodObject<{
                            id: z.ZodString;
                            name: z.ZodString;
                            email: z.ZodString;
                            plan: z.ZodString;
                        ...
                        planBreakdown: z.ZodObject<{
                            basic: z.ZodNumber;
                            pro: z.ZodNumber;
                            premium: z.ZodNumber;
                        }, z.core.$strip>;
                        activeSubscriptions: z.ZodNumber;
                        cancelledSubscriptions: z.ZodNumber;
                        expiredSubscriptions: z.ZodNumber;
                    }, z.core.$strip>;
                };
            };
            description: string;
    ...
    getRoutingPath(): "/sales";
};
export type GetSalesRoute = typeof getSales;
