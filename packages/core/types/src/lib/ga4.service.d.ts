...
/**
 * Get geographical data (countries and cities) for last 7 days
 */
export declare function getGeographyData(): Promise<import("@google-analytics/data/build/protos/protos").google.analytics.data.v1beta.IRunReportResponse>;
/**
 * Get traffic by hour of day for last 7 days
 */
export declare function getHourlyTraffic(): Promise<import("@google-analytics/data/build/protos/protos").google.analytics.data.v1beta.IRunReportResponse>;
/**
 * Get device breakdown (desktop, mobile, tablet)
 */
export declare function getDeviceBreakdown(): Promise<import("@google-analytics/data/build/protos/protos").google.analytics.data.v1beta.IRunReportResponse>;
/**
